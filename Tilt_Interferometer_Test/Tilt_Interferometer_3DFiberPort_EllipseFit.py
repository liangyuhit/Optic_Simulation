...
for i in range(len(dx)*len(dy)-1):
    plt.subplot(2,4,i+2)
    plt.plot(V_x_2_set, a_set[i], label='semi-major', color='red', linestyle='solid', linewidth=1, marker='o', fillstyle='full', markeredgecolor='red', markeredgewidth=0.0)
    plt.plot(V_x_2_set, b_set[i], label='semi-minior', color='blue', linestyle='solid', linewidth=1, marker='o', fillstyle='full', markeredgecolor='red', markeredgewidth=0.0)
    plt.xlabel('V_x_2')
    plt.legend(loc='best')
plt.savefig('C:/Users/yu03/Desktop/Gabor/Interferometer Sim/Simulation_Result/1. V_x_2 Modulation/Compare.jpg', dpi=300)
plt.close()
